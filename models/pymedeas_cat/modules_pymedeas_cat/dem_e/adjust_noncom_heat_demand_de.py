"""
Module adjust_noncom_heat_demand_de
...
def share_feh_over_fed_coal():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_feh_over_fed_coal')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_feh_over_fed_nat_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_feh_over_fed_nat_gas')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_feh_over_fed_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_feh_over_fed_oil')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_feh_over_fed_solid_bioe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_feh_over_fed_solids_bioe')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
