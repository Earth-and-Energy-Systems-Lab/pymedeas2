...
def annual_gdp_growth_rate_aut():
    ...
    Original Eqn: -1+ZIDZ( GDP AUT, GDP delayed 1yr )
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def gdp_by_sector():
    ...
    Original Eqn: Real final demand by sector AUT[sectors]+IC total exports[sectors]-IC total imports[sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def gdp_by_sector_delayed_1yr():
    ...
    Original Eqn: DELAY FIXED( GDP by sector[sectors], 1, GDP by sector[sectors])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def gdp_by_sector_growth_rate():
    ...
    Original Eqn: -1+ZIDZ(GDP by sector[sectors], GDP by sector delayed 1yr[sectors])
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def gdp_delayed_1yr():
    ...
    Original Eqn: DELAY FIXED( GDP AUT, 1, 0.22)
    Units: Tdollars/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def gdppc():
    """
    Real Name: GDPpc
    Original Eqn: GDP AUT*dollars to Tdollars/Population
    Units: $/people
    Limits: (None, None)
    Type: component
    Subs: None
...
def real_demand():
    ...
    Original Eqn: SUM(Real final demand by sector AUT[sectors!])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    Total demand
    """
    return sum(real_final_demand_by_sector_aut(), dim=("sectors",))
...
def real_demand_by_sector_delayed_aut():
    ...
    Original Eqn: DELAY FIXED ( Real final demand by sector AUT[sectors], 1, 10)
    Units: $
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_demand_delayed_1yr():
    ...
    Original Eqn: SMOOTH N(Real demand Tdollars, 1, 0.2, 12)
    Units:
    Limits: (None, None)
    Type: component
    Subs: None
...
def real_domestic_demand_by_sector_aut():
    ...
    Original Eqn: MAX(0, SUM(IA Matrix Domestic[sectors,sectors1!]*Real total output by sector AUT[sectors1!]))
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_final_demand_by_sector_aut():
    ...
    Original Eqn: MAX(0,Real domestic demand by sector AUT[sectors]+Real Final Demand of Exports[sectors])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_final_energy_by_sector_and_fuel_aut():
    ...
    Original Eqn: Required final energy by sector and fuel AUT[final sources,sectors]*Energy scarcity feedback shortage coeff AUT[ final sources]*CC impacts feedback shortage coeff
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: ['final sources', 'sectors']
...
def real_total_output():
    ...
    Original Eqn: SUM(Real total output by sector AUT[sectors!])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    Total output (1995$).
    """
    return sum(real_total_output_by_sector_aut(), dim=("sectors",))
...
def real_total_output_by_fuel_and_sector():
    ...
    Original Eqn: XIDZ(Real final energy by sector and fuel AUT[final sources,sectors], Final energy intensity by sector and fuel EU[ final sources,sectors], Total output required by sector[sectors]/1e+06)*1e+06
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['final sources', 'sectors']
...
def required_fed_sectors_by_fuel():
    ...
    Original Eqn: SUM(Required final energy by sector and fuel AUT[final sources,sectors!])
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: ['final sources']
    ...
    """
    return sum(required_final_energy_by_sector_and_fuel_aut(), dim=("sectors",))
...
def shortage_coef_without_min_without_elosses():
    ...
    Original Eqn: ZIDZ(real FE consumption by fuel before heat correction[final sources],Required FED by fuel before heat correction[final sources])
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: ['final sources']
...
def total_output_required_by_sector():
    ...
    Original Eqn: Required total output for exports[sectors]+Total domestic output required by sector[ sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
