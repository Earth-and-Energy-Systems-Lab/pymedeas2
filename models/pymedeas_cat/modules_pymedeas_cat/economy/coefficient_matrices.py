...
@component.add(
    ...
    units="Dmnl",
    subscripts=[
        np.str_("economic_years"),
        np.str_("sectors_A_matrix"),
        np.str_("sectors_A_matrix1"),
    ],
    comp_type="Constant",
...
@component.add(
    name="I_Matrix",
    units="Dmnl",
    subscripts=[np.str_("sectors_A_matrix"), np.str_("sectors_A_matrix1")],
    comp_type="Constant",
    comp_subtype="Normal",
)
def i_matrix():
...
def ia_matrix_domestic():
    return xr.DataArray(
        ...
        .rename(
            {
                np.str_("sectors_A_matrix"): "sec_map_2",
                np.str_("sectors_A_matrix1"): "secb_map_2",
            }
        )
        .values,
        {
...
def ia_matrix_exports_0():
    return xr.DataArray(
        ...
        .rename(
            {
                np.str_("sectors_A_matrix"): "sec_map_2",
                np.str_("sectors_A_matrix1"): "secb_map_0",
            }
        )
        .values,
        {
...
def ia_matrix_exports_1():
    return xr.DataArray(
        ...
        .rename(
            {
                np.str_("sectors_A_matrix"): "sec_map_2",
                np.str_("sectors_A_matrix1"): "secb_map_1",
            }
        )
        .values,
        {
...
def ia_matrix_imports_0():
    return xr.DataArray(
        ...
        .rename(
            {
                np.str_("sectors_A_matrix"): "sec_map_0",
                np.str_("sectors_A_matrix1"): "secb_map_2",
            }
        )
        .values,
...
def ia_matrix_imports_1():
    return xr.DataArray(
        ...
        .rename(
            {
                np.str_("sectors_A_matrix"): "sec_map_1",
                np.str_("sectors_A_matrix1"): "secb_map_2",
            }
        )
        .values,
