...
def demand_by_sector_roeu():
    ...
    Original Eqn: IF THEN ELSE(Time<2009,historic demand 1[sectors],Real demand by sector RoEU[sectors])
    Units: Tdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def demand_by_sector_row():
    ...
    Original Eqn: IF THEN ELSE(Time<2009,historic demand 0[sectors],Real demand by sector RoW[sectors])
    Units: Tdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def domestic_output_required_for_exports_roeu_by_sector():
    ...
    Original Eqn: SUM(Leontief Matrix Exports 1[sectors,sectors1!]*Demand by sector RoEU[sectors1!])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
    ...
    """
    return sum(
        leontief_matrix_exports_1()
        * rearrange(demand_by_sector_roeu(), ["sectors1"], _subscript_dict),
        dim=("sectors1",),
    )
...
def domestic_output_required_for_exports_row_by_sector():
    ...
    Original Eqn: SUM(Leontief Matrix Exports 0[sectors,sectors1!]*Demand by sector RoW[sectors1!])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def historic_demand_0():
    ...
    Original Eqn: GET DIRECT DATA('../economy.xlsx', 'Catalonia', 'time_index_2009', 'historic_demand_0')
    Units: Mdollars
    Limits: (None, None)
...
def historic_demand_1():
    ...
    Original Eqn: GET DIRECT DATA('../economy.xlsx', 'Catalonia', 'time_index_2009', 'historic_demand_1')
    Units: Mdollars
    Limits: (None, None)
    Type: component_ext_data
    Subs: ['sectors']
...
def ic_exports_aut_from_roeu():
    ...
    Original Eqn: SUM(IC exports AUT matrix to RoEU[sectors,sectors1!])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
    ...
    """
    return sum(ic_exports_aut_matrix_to_roeu(), dim=("sectors1",))
...
def ic_exports_aut_matrix_to_roeu():
    ...
    Original Eqn: -IA Matrix Exports 1[sectors,sectors1]*Real total output by sector RoEU[ sectors1]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    ...
    """
    return -ia_matrix_exports_1() * rearrange(
        real_total_output_by_sector_roeu(), ["sectors1"], _subscript_dict
    )
...
def ic_exports_aut_matrix_to_row():
    ...
    Original Eqn: -IA Matrix Exports 0[sectors,sectors1]*Real total output by sector RoW[ sectors1]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'sectors1']
    ...
    Intermediate products exports by sector
    """
    return -ia_matrix_exports_0() * rearrange(
...
def ic_exports_aut_to_row():
    ...
    Original Eqn: SUM(IC exports AUT matrix to RoW[sectors,sectors1!])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
    ...
    Total intermediate products exports
    """
    return sum(ic_exports_aut_matrix_to_row(), dim=("sectors1",))
...
def ic_imports_aut_from_row():
    ...
    Original Eqn: SUM(IC imports AUT matrix from RoW[sectors1!,sectors])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
    ...
    return sum(
        rearrange(
            ic_imports_aut_matrix_from_row(), ["sectors1", "sectors"], _subscript_dict
        ),
        dim=("sectors1",),
    )
...
def ic_imports_aut_matrix_from_roeu():
    ...
    Original Eqn: -IA Matrix Imports 1[sectors,sectors1]*Real total output by sector AUT[ sectors1]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'sectors1']
    ...
    """
    return -ia_matrix_imports_1() * rearrange(
        real_total_output_by_sector_aut(), ["sectors1"], _subscript_dict
    )
...
def ic_imports_aut_matrix_from_row():
    ...
    Original Eqn: -IA Matrix Imports 0[sectors,sectors1]*Real total output by sector AUT[ sectors1]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'sectors1']
    ...
    Intermediate products imports by sector
    """
    return -ia_matrix_imports_0() * rearrange(
        real_total_output_by_sector_aut(), ["sectors1"], _subscript_dict
    )
...
def ic_imports_aut_to_roeu():
    ...
    Original Eqn: SUM(IC imports AUT matrix from RoEU[sectors1!,sectors])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
    ...
    return sum(
        rearrange(
            ic_imports_aut_matrix_from_roeu(), ["sectors1", "sectors"], _subscript_dict
        ),
        dim=("sectors1",),
    )
...
def ic_total_exports():
    ...
    Original Eqn: IC exports AUT from RoEU[sectors]+IC exports AUT to RoW[sectors]
    Units:
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def ic_total_imports():
    ...
    Original Eqn: IC imports AUT from RoW[sectors]+IC imports AUT to RoEU[sectors]
    Units:
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_demand_by_sector_roeu():
    ...
    Original Eqn: Real demand by sector EU28[sectors]-Real demand by sector delayed AUT[ sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_demand_by_sector_row():
    ...
    Original Eqn: Real demand by sector World[sectors]-Real demand by sector EU28[sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_final_demand_of_exports():
    ...
    Original Eqn: Real Final Demand of exports to RoEU[sectors]+Real Final Demand of exports to RoW[sectors]
    Units:
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_final_demand_of_exports_to_roeu():
    ...
    Original Eqn: SUM(IA Matrix Exports 1[sectors,sectors1!]*Real total output by sector RoEU[sectors1!])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
    ...
    return sum(
        ia_matrix_exports_1()
        * rearrange(real_total_output_by_sector_roeu(), ["sectors1"], _subscript_dict),
        dim=("sectors1",),
    )
...
def real_final_demand_of_exports_to_row():
    ...
    Original Eqn: SUM(IA Matrix Exports 0[sectors,sectors1!]*Real total output by sector RoW[sectors1!])
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_total_output_by_sector_roeu():
    ...
    Original Eqn: Real total output by sector EU28[sectors]-Real total output by sector AUT[ sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def real_total_output_by_sector_row():
    ...
    Original Eqn: Real total output by sector World[sectors]-Real total output by sector EU28[sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def required_total_output_for_exports():
    ...
    Original Eqn: Domestic output required for exports Row by sector[sectors]+Domestic output required for exports RoEU by sector[sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def total_domestic_output_required_for_exports_from_roeu_by_sector():
    ...
    Original Eqn: Domestic output required for exports RoEU by sector[sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
...
def total_domestic_output_required_for_exports_from_row_by_sector():
    ...
    Original Eqn: Domestic output required for exports Row by sector[sectors]
    Units: Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors']
