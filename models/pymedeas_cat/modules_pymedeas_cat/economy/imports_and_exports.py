...
def domestic_output_required_for_exports_roeu_by_sector():
    ...
    """
    return sum(
        leontief_matrix_exports_1().rename({np.str_("sectors1"): "sectors1!"})
        * demand_by_sector_roeu().rename({np.str_("sectors"): "sectors1!"}),
        dim=["sectors1!"],
    )
...
def domestic_output_required_for_exports_row_by_sector():
    ...
    """
    return sum(
        leontief_matrix_exports_0().rename({np.str_("sectors1"): "sectors1!"})
...
def ic_exports_cat_from_roeu():
    ...
    """
    return sum(
        ic_exports_cat_matrix_to_roeu().rename({np.str_("sectors1"): "sectors1!"}),
        dim=["sectors1!"],
    )
...
def ic_exports_cat_to_row():
    ...
    """
    return sum(
        ic_exports_cat_matrix_to_row().rename({np.str_("sectors1"): "sectors1!"}),
        dim=["sectors1!"],
    )
...
def real_final_demand_of_exports_to_roeu():
    ...
    """
    return sum(
        ia_matrix_exports_1().rename({np.str_("sectors1"): "sectors1!"})
        * real_total_output_by_sector_roeu().rename({np.str_("sectors"): "sectors1!"}),
        dim=["sectors1!"],
    )
...
def real_final_demand_of_exports_to_row():
    ...
    """
    return sum(
        ia_matrix_exports_0().rename({np.str_("sectors1"): "sectors1!"})
