"""
Module electricity_demand_ff_ee
...
def a_lineal_regr_phaseout_oil_for_elec():
    ...
    Original Eqn: (share in target year FF for elec-"Hist share oil/FF Elec")/("target year policy phase-out FF for elec"-"start year policy phase-out oil for elec")
    Units:
    Limits: (None, None)
    Type: component
    Subs: None
...
def b_lineal_regr_phaseout_ff_for_elec():
    """
    Real Name: "b lineal regr phase-out FF for elec"
    Original Eqn: share in target year FF for elec-"a lineal regr phase-out oil for elec" *"target year policy phase-out FF for elec"
    Units:
    Limits: (None, None)
    Type: component
    Subs: None
...
def efficiency_coal_for_electricity():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'efficiency_coal_for_electricity')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_liquids_for_electricity():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'efficiency_liquids_for_electricity')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def hist_share_gascoal_gas_elec():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_share_of_electricity_produced_from_gas_over_electricity_produced_coal_and_gas')
    Units: Dmnl
    Limits: (None, None)
...
def hist_share_oilff_elec():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_share_of_electricity_produced_from_oil_over_total_fossil_electricity')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def historic_efficiency_gas_for_electricity(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Austria', 'time_efficiencies', 'historic_efficiency_gas_for_electricity'))
    Units: percent
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def initial_efficiency_gas_for_electricity():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'initial_efficiency_gas_for_electricity')
    Units: percent
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_share_oil_oil_elec():
    """
    Real Name: P share oil oil Elec
    Original Eqn: MAX(0, "a lineal regr phase-out oil for elec"*Time+"b lineal regr phase-out FF for elec")
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def share_gascoalgas_for_elec_in_2014():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_of_electricity_produced_from_gas_over_electricity_produced_coal_and_gas_2014')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_oilff_for_elec_in_2015():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_of_electricity_produced_from_oil_over_total_fossil_electricity_2015')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
