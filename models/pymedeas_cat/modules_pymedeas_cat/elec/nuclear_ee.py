...
def p_nuclear_scen34():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'F22')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def selection_of_nuclear_scenario():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'D19')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_nuclear_growth_scen34():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'H22')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
