...
def importsexports_electricity():
    """
    Real Name: "imports/exports electricity"
    Original Eqn: IF THEN ELSE(Time<2015,-FE Elec demand exports TWh,IF THEN ELSE(Total FE Elec generation TWh EU28>(Demand Elec NRE TWh-Real FE demand NRE ),(Demand Elec NRE TWh -Real FE demand NRE)-FE Elec demand exports TWh,Total FE Elec generation TWh EU28))
    Units:
    Limits: (None, None)
    Type: component
    Subs: None
...
def real_fe_demand_nre():
    """
    Real Name: Real FE demand NRE
    Original Eqn: FE demand coal Elec plants TWh+FE demand gas Elec plants TWh+FE demand oil Elec plants TWh +FE nuclear Elec generation TWh+(FES Elec fossil fuel CHP plants EJ /EJ per TWh)
    Units: TWh/Year
    Limits: (None, None)
    Type: component
    Subs: None
