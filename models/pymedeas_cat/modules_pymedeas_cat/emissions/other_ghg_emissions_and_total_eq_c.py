"""
Module other_ghg_emissions_and_total_eq_c
...
def ch4_anthro_emissions():
    ...
    Original Eqn: Total CH4 emissions fossil fuels+IF THEN ELSE(Choose RCP=1, CH4 anthro emissions RCP[RCP26], IF THEN ELSE(Choose RCP=2, CH4 anthro emissions RCP[RCP45], IF THEN ELSE(Choose RCP=3, CH4 anthro emissions RCP[RCP60], CH4 anthro emissions RCP[RCP85])))
    Units: Mton/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def ch4_anthro_emissions_rcp():
    ...
    Original Eqn: GET DIRECT DATA('../climate.xlsx', 'Austria', 'year_emissions', 'CH4_emissions')
    Units: Mton/Year
    Limits: (None, None)
...
def choose_rcp():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'G116')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def hfc_emissions_rcp():
    ...
    Original Eqn: 
      GET DIRECT DATA('../climate.xlsx', 'Austria', 'year_emissions', 'HFC134a_emissions')\
        .
        .
        .
      GET DIRECT DATA('../climate.xlsx', 'Austria', 'year_emissions', 'HFC4310mee_emissions')
    Units: tons/Year
    Limits: (None, None)
    Type: component_ext_data
...
def n2o_anthro_emissions_rcp():
    ...
    Original Eqn: GET DIRECT DATA('../climate.xlsx', 'Austria', 'year_emissions', 'N2O_emissions')
    Units: Mton N/Year
    Limits: (None, None)
    Type: component_ext_data
    Subs: ['RCP Scenario']
...
def pfc_emissions_rcp():
    ...
    Original Eqn: GET DIRECT DATA('../climate.xlsx', 'Austria', 'year_emissions', 'PFCs_emissions')
    Units: tons/Year
    Limits: (None, None)
    Type: component_ext_data
    Subs: ['RCP Scenario']
...
def sf6_emissions_rcp():
    ...
    Original Eqn: GET DIRECT DATA('../climate.xlsx', 'Austria', 'year_emissions', 'SF6_emissions')
    Units: tons/Year
    Limits: (None, None)
    Type: component_ext_data
    Subs: ['RCP Scenario']
