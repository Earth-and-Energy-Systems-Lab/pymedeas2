...
def abundance_total_oil_aut():
    """
    Real Name: abundance total oil AUT
    Original Eqn: IF THEN ELSE(PED total oil EJ<PES total oil EJ AUT, 1, 1-ZIDZ((PED total oil EJ-PES total oil EJ AUT), PED total oil EJ ))
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    """
    return if_then_else(
        ped_total_oil_ej() < pes_total_oil_ej_aut(),
        lambda: 1,
        lambda: 1
        - zidz((ped_total_oil_ej() - pes_total_oil_ej_aut()), ped_total_oil_ej()),
    )
...
def cumulated_conv_oil_extraction_to_1995():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'cumulative_conventional_oil_extraction_until_1995')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def cumulated_unconv_oil_extraction_to_1995():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'cumulative_unconventional_oil_extraction_until_1995')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def extraction_conv_oil_ej():
    ...
    Original Eqn: IF THEN ELSE(RURR conv oil<0,0, IF THEN ELSE(Time<2016 :OR:"unlimited NRE?"=1 :OR: "unlimited oil?"=1, "PED domestic AUT conv. oil EJ", MIN("PED domestic AUT conv. oil EJ", max extraction conv oil EJ) ))
    Units: EJ/Year
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    return if_then_else(
        ...
        lambda: 0,
        lambda: if_then_else(
            logical_or(time() < 2016, unlimited_nre() == 1, unlimited_oil() == 1),
            lambda: ped_domestic_aut_conv_oil_ej(),
            lambda: np.minimum(
                ped_domestic_aut_conv_oil_ej(), max_extraction_conv_oil_ej()
            ),
        ),
    )
...
def extraction_tot_agg_oil_ej():
    ...
    Original Eqn: IF THEN ELSE(RURR tot agg oil<0,0, IF THEN ELSE(Time<2016 :OR: "unlimited NRE?"=1 :OR: "unlimited oil?"=1, PED domestic AUT total oil EJ, MIN(PED domestic AUT total oil EJ, max extraction tot agg oil EJ)))
    Units: EJ/Year
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    return if_then_else(
        ...
        lambda: if_then_else(
            logical_or(time() < 2016, unlimited_nre() == 1, unlimited_oil() == 1),
            lambda: ped_domestic_aut_total_oil_ej(),
            lambda: np.minimum(
                ped_domestic_aut_total_oil_ej(), max_extraction_tot_agg_oil_ej()
            ),
        ),
    )
...
def historic_unconv_oil():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_unconventional_oil_extraction')
    Units: EJ/Year
    Limits: (None, None)
...
def p_constraint_growth_extraction_unconv_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_constraint_growth_extraction_unconv_oil')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def pec_conv_oil():
    ...
    Original Eqn: real extraction conv oil EJ+imports AUT conv oil from RoW EJ
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def pec_unconv_oil():
    ...
    Original Eqn: real extraction unconv oil EJ+imports AUT unconv oil from RoW EJ
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def pes_oil_ej_delayed():
    ...
    Original Eqn: DELAY FIXED ( PES total oil EJ AUT, 0.1, 0.5)
    Units: EJ/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def pes_oil_mbd():
    ...
    Original Eqn: PES total oil EJ AUT*"Mb/d per EJ/year"
    Units: Mb/d
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    """
    return pes_total_oil_ej_aut() * mbd_per_ejyear()


def pes_total_oil_ej_aut():
    """
    Real Name: PES total oil EJ AUT
...
def separate_conv_and_unconv_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'separate_conv_and_unconv_oil')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_conv_oil_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'share_RURR_conv_oil_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_tot_agg_oil_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'share_RURR_agg_oil_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_unconv_oil_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'share_RURR_unconv_oil_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_unconv_oil_vs_tot_agg():
    ...
    Original Eqn: IF THEN ELSE(Time>2012, MIN(evolution share unconv oil vs tot agg, 1), ZIDZ( Historic unconv oil, PED total oil EJ))
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def share_unconv_oil_vs_tot_agg_in_2050():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_unconv_vs_agg_oil_in_2050')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_conv_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_policy_year_conv_oil_underground')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_tot_agg_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_policy_year_agg_oil_underground')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_unconv_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_policy_year_unconv_oil_underground')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def table_max_extraction_agg_oil(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Austria', 'RURR_agg_oil', 'max_extraction_agg_oil'))
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def table_max_extraction_conv_oil(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Austria', 'RURR_conv_oil', 'max_extraction_conv_oil'))
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def table_max_extraction_unconv_oil(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Austria', 'RURR_unconv_oil', 'max_extraction_unconv_oil'))
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def unlimited_nre():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'unlimited_NRE')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def unlimited_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'unlimited_oil')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_conv_oil_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'URR_conv_oil')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_tot_agg_oil_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'URR_agg_oil')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_unconv_oil_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'URR_unconv_oil')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def year_scarcity_oil():
    ...
    Original Eqn: IF THEN ELSE(abundance total oil AUT>0.95, 0, Time)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    Year when the parameter abundance falls below 0.95, i.e. year when
        scarcity starts.
    """
    return if_then_else(abundance_total_oil_aut() > 0.95, lambda: 0, lambda: time())
