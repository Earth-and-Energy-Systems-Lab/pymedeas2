...
def efficiency_coal_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_efficiencies', 'historic_efficiency_coal_heat_plants')
    Units: Dmnl
    Limits: (None, None)
...
def efficiency_gases_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_efficiencies', 'historic_efficiency_gases_for_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def efficiency_liquids_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_efficiencies', 'historic_efficiency_liquids_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def historic_share_liquids_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_share_of_liquids_in_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def phaseout_oil_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'phase_out_oil_heat')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_gascoalgas_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_share_of_heat_produced_from_gas_over_electricity_produced_coal_and_gas')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def share_in_target_year_oil_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'share_target_year_oil_for_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_policy_phaseout_oil_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_policy_phase_out_oil_for_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def target_year_policy_phaseout_oil_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'target_year_policy_phase_out_oil_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
