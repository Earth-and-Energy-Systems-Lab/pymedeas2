...
def choose_energy_intensity_target_method():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'choose_energy_intensity_target_method')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def increase_of_intensity_due_to_change_energy_technology_h_top_down():
    ...
    When in households, one type of energy (a) is replaced by another (b), the energy
        ...
        TOP DOWN[liquids]*efficiency rate of substitution        H,[gases,liquids]                -----                Decrease of intensity due to energy a technology change H TOP DOWN[gases]*efficiency
...
def pct_change_energy_intensity_target():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'pct_change_energy_intensity_target')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def percentage_of_change_over_the_historic_maximun_variation_of_energy_intensities():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_change_over_hist_max_variation_FEI')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_modification_ei():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_modification_EI')
    Units:
    Limits: (None, None)
    Type: constant
    Subs: None
...
def year_change_pct_energy_intensity_target():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'year_change_pct_energy_intensity_target')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
