...
def max_pe_biogas_ej():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'max_PE_biogas')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_biogas():
    """
    Real Name: P biogas
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_biogas_growth')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
