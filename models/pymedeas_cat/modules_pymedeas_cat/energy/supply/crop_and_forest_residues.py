...
def max_npp_potential_bioe_residues():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'max_NPP_pot_bioe_residues')
    Units: EJ/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_bioe_residues():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_bioe_residues_growth')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_cellulosic_biofuels_vs_bioe_residues():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'share_cellulosic_biof_vs_bioe_res')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_bioe_residues_for_nonbiofuels():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_bioe_residues_non_biofuels')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
