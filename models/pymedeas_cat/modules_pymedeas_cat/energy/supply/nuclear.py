...
def cp_nuclear_initial():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'cp_initial_nuclear')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def effects_shortage_uranium():
    ...
    Original Eqn: IF THEN ELSE((extraction uranium EJ AUT+extraction uranium RoW)=0, 0, IF THEN ELSE(abundance uranium>0.8, ((abundance uranium-0.8)*5)^2, 0))
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def historic_nuclear_generation_twh(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_nuclear_generation'))
    Units: TWh/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def initial_gen_nuclear():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'initial_nuclear_generation')
    Units: TWh
    Limits: (None, None)
    Type: constant
    Subs: None
...
def min_cp_nuclear():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'minimum_cp_nuclear')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_nuclear_scen34():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_nuclear_scen3_4_variation')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def pe_demand_uranium_aut_ej():
    """
    Real Name: PE demand uranium AUT EJ
...
def selection_of_nuclear_scenario():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'select_nuclear_scen')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_nuclear_growth_scen34():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_nuclear_variation_scen3_4')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
