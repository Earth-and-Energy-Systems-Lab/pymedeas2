...
def p_geothermal_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_geot_heat_growth')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_solar_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_solar_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_solid_bioe_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_solid_bioe_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_p_growth_res_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_p_growth_RES_heat')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def target_year_p_growth_res_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'target_year_p_growth_RES_heat')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
