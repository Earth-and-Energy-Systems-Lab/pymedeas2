...
def quality_of_electricity_2015():
    ...
    Original Eqn: SAMPLE IF TRUE(Time<2015, share total final energy vs TPES, share total final energy vs TPES)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def share_imports_aut_nre_from_row_vs_world_extraction():
    ...
    Original Eqn: Total imports AUT NRE from Row/Total extraction NRE EJ World
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def share_imports_aut_nre_vs_tpec():
    ...
    Original Eqn: Total imports AUT NRE from Row/TPES EJ
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def total_consumption_nre_ej():
    ...
    Original Eqn: extraction coal EJ AUT+imports AUT coal from RoW EJ+real extraction conv gas EJ+real extraction conv oil EJ +real extraction unconv gas EJ+real extraction unconv oil EJ+extraction uranium EJ AUT+"imports AUT nat. gas from RoW EJ" +imports AUT total oil from RoW EJ+extraction uranium RoW
    Units: EJ/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def total_imports_aut_nre_from_row():
    ...
    Original Eqn: extraction uranium RoW+imports AUT coal from RoW EJ+"imports AUT nat. gas from RoW EJ"+imports AUT total oil from RoW EJ
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
