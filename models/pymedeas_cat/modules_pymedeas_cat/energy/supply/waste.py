...
def efficiency_waste_for_elec_chp_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'efficiency_waste_for_elec_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_waste_for_elec_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'efficiency_waste_for_elec_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_waste_for_heat_chp_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'efficiency_waste_for_heat_CHP_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_waste_for_heat_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'efficiency_waste_for_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_pes_waste_ej(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_primary_energy_supply_of_waste')
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def initial_pes_waste():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'initial_primary_energy_supply_from_waste')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_pe_waste():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'max_PE_waste')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_waste_change():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_waste_growth')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def past_waste_growth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'historic_average_pes_from_waste_growth')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_waste_for_chp():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_pes_waste_for_chp')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_waste_for_elec_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_pes_waste_for_elec_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_waste_for_heatcom_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_pes_waste_for_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_waste_tfc():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_pes_waste_tfc')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def waste_change():
    ...
    Original Eqn: IF THEN ELSE(Annual GDP growth rate AUT<0, Annual GDP growth rate AUT , P waste change)
    Units: 1/Year
    Limits: (None, None)
    Type: component
    Subs: None
