...
def adapt_growth_biofuels_2gen():
    ...
    Original Eqn: IF THEN ELSE(Time<2015, 0, IF THEN ELSE(Time<2020, past biofuels 2gen+(P biofuels 2gen land compet-past biofuels 2gen)*(Time-2015)/5, P biofuels 2gen land compet))
    Units: 1/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def additional_land_compet_available_for_biofuels():
    ...
    Original Eqn: Agricultural land*"max additional potential land for biofuels (compet)"
    Units: MHa
    Limits: (None, None)
    Type: component
    Subs: None
...
def annual_shift_from_2gen_to_3gen():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'annual_shift_from_second_generation_to_third_generation')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def biofuel_production_2015():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'production_of_second_generation_biofuel_2015')
    Units: ktoe/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_produc_biofuels_2gen(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_production_of_second_generation_biofuels'))
    Units: ktoe/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def initial_value_land_compet_biofuels_2gen_ktoe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'initial_production_of_second_generation_biofuels')
    Units: EJ/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def land_compet_available_for_biofuels_2gen_2015():
    ...
    Original Eqn: biofuel production 2015*EJ per ktoe/Land productivity biofuels 2gen EJ MHa
    Units: MHa/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def max_additional_potential_land_for_biofuels_compet():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'max_additional_pot_land_biofuels')
    Units: MHa
    Limits: (None, None)
    Type: constant
    Subs: None

    Additional (apart from historically used) available land for biofuels in
        competition with other uses as a share of total agricultural land.
    """
...
def max_land_compet_biofuels_2gen():
    ...
    Original Eqn: Additional land compet available for biofuels+Land compet available for biofuels 2gen 2015
    Units: MHa
    Limits: (None, None)
    Type: component
    Subs: None
...
def new_biofuels_2gen_land_compet():
    ...
    Original Eqn: IF THEN ELSE(check liquids<0, "constrain liquids exogenous growth?" *Land compet biofuels 2gen Mha , MAX(Annual additional historic land use biofuels 2gen+adapt growth biofuels 2gen *Land compet biofuels 2gen Mha*Biofuels land compet available,0))*"scarcity agricultural land?"
    Units: MHa/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def p_biofuels_2gen_land_compet():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_biofuels_2gen_land_compet_growth')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_biofuels_3gen_land_compet():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_biofuels_3gen_land_compet_growth')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def past_biofuels_2gen():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'historic_growth_biofuels_second_generation')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_3gen_cellulosic_biofuels():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_3gen_cell_biofuels')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
