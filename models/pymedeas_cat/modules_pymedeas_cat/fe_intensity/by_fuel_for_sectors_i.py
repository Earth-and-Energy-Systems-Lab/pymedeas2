...
def efficiency_rate_of_substitution():
    ...
    Original Eqn:
      GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'efficiency_rate_of_substitution_electricity*')
      GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'efficiency_rate_of_substitution_heat*')
      GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'efficiency_rate_of_substitution_liquids*')
      GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'efficiency_rate_of_substitution_gases*')
      GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'efficiency_rate_of_substitution_solids*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
...
def energy_intensity_target_mdollar():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'energy_intensity_target*')
    Units:
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def final_year_energy_intensity_target():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'final_year_energy_intensity_target')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_final_energy_intensity(x):
    ...
    Original Eqn:
      GET DIRECT LOOKUPS('../economy.xlsx', 'Catalonia', 'time_index2009', 'historic_final_energy_intensity_electricity')
      GET DIRECT LOOKUPS('../economy.xlsx', 'Catalonia', 'time_index2009', 'historic_final_energy_intensity_heat')
      GET DIRECT LOOKUPS('../economy.xlsx', 'Catalonia', 'time_index2009', 'historic_final_energy_intensity_liquids')
      GET DIRECT LOOKUPS('../economy.xlsx', 'Catalonia', 'time_index2009', 'historic_final_energy_intensity_gases')
      GET DIRECT LOOKUPS('../economy.xlsx', 'Catalonia', 'time_index2009', 'historic_final_energy_intensity_solids')
    Units: EJ/Mdollars
    Limits: (None, None)
    Type: lookup
...
def historic_mean_rate_energy_intensity():
    ...
    Original Eqn:
      GET DIRECT CONSTANTS('../economy.xlsx', 'Catalonia', 'historic_mean_rate_energy_intensity_electricity*')
      GET DIRECT CONSTANTS('../economy.xlsx', 'Catalonia', 'historic_mean_rate_energy_intensity_heat*')
      GET DIRECT CONSTANTS('../economy.xlsx', 'Catalonia', 'historic_mean_rate_energy_intensity_liquids*')
      GET DIRECT CONSTANTS('../economy.xlsx', 'Catalonia', 'historic_mean_rate_energy_intensity_gases*')
      GET DIRECT CONSTANTS('../economy.xlsx', 'Catalonia', 'historic_mean_rate_energy_intensity_solids*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def max_yearly_change_between_sources():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'max_yearly_change_between_sources*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def maximum_yearly_acceleration_of_intensity_improvement():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'maximum_yearly_acceleration_of_intensity_improvement*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def minimum_fraction_source():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'minimum_fraction_source*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def policy_change_energy_speed():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'policy_change_energy_speed*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def policy_to_improve_efficiency_speed():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'policy_to_improve_efficiency_speed*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def scarcity_feedback_final_fuel_replacement_flag():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'scarcity_feedback_final_fuel_replacement_flag')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def year_policy_change_energy():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'year_policy_change_energy*')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def year_policy_to_improve_efficiency():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'year_policy_to_improve_efficiency*')
    Units:
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
...
def year_to_finish_energy_intensity_policies():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'year_to_finish_energy_intensity_policies*')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: ['SECTORS H', 'final sources']
