...
def d_jobs_fuel_supply_solids_bioe():
    ...
    Original Eqn: MAX(0,PES solids bioE EJ*Employment factor fuel supply solids bioE*1000)
    Units: people
    Limits: (None, None)
    Type: component
    Subs: None
...
def d_jobs_new_installed_res_elec_per_techn():
    ...
    Original Eqn: MAX(0,RES elec capacity under construction TW[RES elec]*Employment factors new RES elec[RES elec]*M per T)
    Units: people
    Limits: (None, None)
    Type: component
    Subs: ['RES elec']
...
def d_jobs_new_installed_res_heat_per_techn():
    ...
    Original Eqn: MAX(0,("new RES capacity for heat-com TW"[RES heat]+"replacement RES for heat-com TW"[RES heat]+"new RES capacity for heat-nc TW"[RES heat]+"replacement RES for heat-nc TW"[RES heat])*Employment factors new RES heat[RES heat]*M per T)
    Units: people
    Limits: (None, None)
    Type: component
    Subs: ['RES heat']
...
def jobs_om_res_elec_per_techn():
    ...
    Original Eqn: MAX(0,installed capacity RES elec TW[RES elec]*"Employment factors O&M RES elec"[RES elec]*M per T)
    Units: people
    Limits: (None, None)
    Type: component
    Subs: ['RES elec']
...
def jobs_om_res_heat_per_techn():
    ...
    Original Eqn: MAX(0,("installed capacity RES heat-com TW"[RES heat]+"installed capacity RES heat-nc TW"[RES heat])*"Employment factors O&M RES heat" [RES heat]*M per T)
    Units: people
    Limits: (None, None)
    Type: component
    Subs: ['RES heat']
