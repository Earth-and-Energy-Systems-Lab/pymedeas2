...
def ar_water():
    """
    Real Name: AR water
    Original Eqn: GET DIRECT CONSTANTS('../parameters.xlsx', 'Austria', 'accessible_runnoff_water')
    Units: km3
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_water_by_type_intensities_by_sector():
    ...
    Original Eqn: IF THEN ELSE( Time<2009, Historic water use[sectors,water](Time)/Real total output by sector AUT[ sectors], 0)
    Units: dam3/Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'water']
...
def renewable_water_resources():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../parameters.xlsx', 'Austria', 'renewable_water_resources')
    Units: km3
    Limits: (None, None)
    Type: constant
    Subs: None
...
def water_use_by_sector():
    ...
    Original Eqn: Water intensity by sector[sectors,water]*Real total output by sector AUT[ sectors]
    Units: dam3
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'water']
