"""
Module recyclingmaterial_extraction_dem_m
...
def choose_targets_mineral_recycling_rates():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'choose_targets_mineral_recycling_rates')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_common_rr_minerals_variation_alt_techn():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'P_common_rr_minerals_variation_alt_techn')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_common_rr_minerals_variation_rest():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'P_common_rr_minerals_variation_Rest')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_rr_minerals_alt_techn():
    ...
    Original Eqn:
      0
      GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'P_rr_minerals_alt_techn*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['materials']
...
def p_rr_minerals_rest():
    ...
    Original Eqn:
      0
      GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'P_rr_minerals_Rest*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['materials']
...
def start_year_p_common_rr_minerals_alt_techn():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_P_common_rr_minerals_alt_techn')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_p_common_rr_minerals_rest():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_P_common_rr_minerals_Rest')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_p_rr_minerals():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'start_year_P_rr_minerals')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def target_year_p_rr_minerals():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'target_year_P_rr_minerals')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
