"""
Module total_extraction_demand_vs_stocks_m
...
def materials_availability_reserves():
    ...
    Original Eqn: IF THEN ELSE(share cum materials to extract alt techn AUT vs reserves World[materials]<1,1,0)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: ['materials']
...
def materials_availability_resources():
    ...
    Original Eqn: IF THEN ELSE(share cum materials to extract alt techn AUT vs resources World[materials]<1,1,0)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: ['materials']
...
def share_cum_materials_to_extract_alt_techn_aut_vs_reserves_world():
    """
    Real Name: share cum materials to extract alt techn AUT vs reserves World
...
def share_cum_materials_to_extract_alt_techn_aut_vs_resources_world():
    """
    Real Name: share cum materials to extract alt techn AUT vs resources World
