...
def share_rurr_coal_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C131')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_coal():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C130')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def unlimited_coal():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'E99')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
