...
def abundance_uranium():
    ...
    Original Eqn: IF THEN ELSE(PE demand uranium AUT EJ=0, 1, IF THEN ELSE((extraction uranium EJ AUT+extraction uranium RoW)>PE demand uranium AUT EJ , 1, 1-((PE demand uranium AUT EJ-extraction uranium EJ AUT -extraction uranium RoW)/PE demand uranium AUT EJ)) )
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def av_past_eu_domestic_uranium_extraction():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'historic_average_domestic_uranium_extraction')
    Units: tonnes
    Limits: (None, None)
    Type: constant
    Subs: None
...
def cumulated_uranium_extraction():
    ...
    Original Eqn: INTEG ( extraction uranium EJ AUT, cumulated uranium extraction to 1995)
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def cumulated_uranium_extraction_to_1995():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'cumulative_uranium_extraction_until_1995')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def extraction_uranium_ej_aut():
    ...
    Original Eqn: IF THEN ELSE(RURR uranium<0,0, IF THEN ELSE(Time<2016, Historic uranium domestic EU extracted t/(kt uranium per EJ*tonnes per kt), IF THEN ELSE("unlimited NRE?"=1 :OR: "unlimited uranium?"=1, PE demand uranium AUT EJ,MIN(PE demand uranium AUT EJ, max extraction uranium EJ))))
    Units: EJ/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def extraction_uranium_kt():
    ...
    Original Eqn: extraction uranium EJ AUT*kt uranium per EJ
    Units: Kt/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def historic_uranium_domestic_eu_extracted_t():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Austria', 'time_historic_data', 'historic_domestic_uranium_extraction')
    Units: EJ
    Limits: (None, None)
...
def imports_eu_uranium_from_row_ej():
    ...
    Original Eqn: PE demand uranium AUT EJ-extraction uranium EJ AUT
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def max_extraction_uranium_ej():
    ...
    Original Eqn: IF THEN ELSE(1=1, av past EU domestic uranium extraction/(kt uranium per EJ*tonnes per kt), table max extraction uranium(RURR uranium))
    Units: EJ/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def pec_uranium_eu_ej():
    ...
    Original Eqn: extraction uranium EJ AUT+extraction uranium RoW
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def rurr_uranium():
    ...
    Original Eqn: INTEG ( -extraction uranium EJ AUT, URR uranium-cumulated uranium extraction to 1995)
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def table_max_extraction_uranium(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Austria', 'RURR_uranium', 'max_extraction_uranium'))
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def urr_uranium_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'URR_uranium')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
