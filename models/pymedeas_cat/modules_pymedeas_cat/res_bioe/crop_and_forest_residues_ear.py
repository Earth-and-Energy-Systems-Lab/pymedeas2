"""
Module crop_and_forest_residues_ear
...
def max_npp_potential_bioe_residues():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C41')
    Units: EJ/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_bioe_residues():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C50')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_cellulosic_biofuels_vs_bioe_residues():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C49')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_bioe_residues_for_nonbiofuels():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C48')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
