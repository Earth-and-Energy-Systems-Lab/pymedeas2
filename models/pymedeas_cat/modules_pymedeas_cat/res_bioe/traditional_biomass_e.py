...
def pe_consumption_trad_biomass_ref():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'pe_consumption_trad_biomass_ref')
    Units: EJ/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def people_relying_trad_biomass_ref():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../parameters.xlsx', 'Austria', 'people_relying_on_traditional_biomass')
    Units: people
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_trad_biomass_vs_solids_in_households():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'share_trad_biomass_vs_solids_in_households')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
