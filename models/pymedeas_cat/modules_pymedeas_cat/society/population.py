...
def p_customized_cte_pop_variation():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_constant_pop_variation')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_customized_year_pop_evolution():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'year_customized_pop_evol')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_pop_asymptote_millions():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'p_pop_asymptote' )
    Units: Mpeople
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_timeseries_pop_growth_rate():
    ...
    Original Eqn: GET DIRECT DATA('../../scenarios/scen_aut.xlsx', 'BAU', 'year_pop_timeseries', 'p_timeseries_pop_growth')
    Units: 1/Year
    Limits: (None, None)
...
def select_population_evolution_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'select_pop_evolution')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def target_year_pop_asymptote():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'target_year_asymptote_pop')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
