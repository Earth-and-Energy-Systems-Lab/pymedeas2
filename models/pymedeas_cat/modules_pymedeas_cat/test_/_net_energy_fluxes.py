"""
Module test_._net_energy_fluxes
...
@component.add(name="last historical year", comp_type="Constant", comp_subtype="Normal")
...
def net_coal_flux_cat():
    return np.minimum(
        ...
        if_then_else(
            ...
            lambda: np.minimum(
                projected_net_coal_flux_cat(time()), maximum_coal_available_in_cat()
            ),
        ),
    )
...
def net_gas_flux_cat():
    return np.minimum(
        ...
        if_then_else(
            ...
            lambda: np.minimum(
                projected_net_gas_flux_cat(time()), maximum_gas_available_in_cat()
            ),
        ),
    )
...
def net_oil_flux_cat():
    return np.minimum(
        ...
        if_then_else(
            ...
            lambda: np.minimum(
                projected_net_oil_flux_cat(time()), maximum_oil_available_in_cat()
            ),
        ),
    )
