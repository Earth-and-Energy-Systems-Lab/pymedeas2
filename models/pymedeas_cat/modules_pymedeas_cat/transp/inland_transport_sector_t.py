"""
Module inland_transport_sector_t
...
def activate_policy_inlandt():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C171')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_bus_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C188')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_bus_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C190')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_bus_hyb():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C189')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_hv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C184')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_hv_hyb():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C183')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_lv_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C185')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_lv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C187')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_lv_hyb():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C186')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_train_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C191')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def t_fin_inlandt():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C175')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def t_ini_inlandt():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'C174')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
