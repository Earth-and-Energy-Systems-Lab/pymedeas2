...
def aaux_hveh():
    """
    Real Name: aaux Hveh
    Original Eqn: IF THEN ELSE( ABS(Time-T ini Hveh)<TIME STEP, percents H vehicles[ Households vehicles], 0 )
    Units:
    Limits: (None, None)
    Type: component
...
def activate_policy_h_transp():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'activate_poicy_hh_transp')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def demand_h():
    """
    Real Name: Demand H
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'initial_households_demand')
    Units: T$
    Limits: (None, None)
    Type: constant
    Subs: None
...
def initial_energy_intensity_of_households_transport_2009():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'initial_energy_intensity_households_transport*')
    Units: EJ/T$
    Limits: (None, None)
    Type: constant
    Subs: ['final sources']
...
def liq_2w():
    """
    Real Name: Liq 2w
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'liq_2w')
    Units:
    Limits: (None, None)
    Type: constant
    Subs: None
...
def liq_4w():
    """
    Real Name: Liq 4w
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'liq_4w')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def n_vehicles_h():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'initial_household_vehicles')
    Units: vehicles
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_2w_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_electric_2w_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_elec_hveh():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_electr_hh_4w_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_gas_hveh():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_gas_hh_veh_4w_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_hyb_hveh():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_hybrid_hh_4w_veh_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_share_2wheelers():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_2w_tfin_over_hh_veh')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def percent_h_vehicles_initial():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'percent_H_vehicles_initial*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['Households vehicles']
...
def t_fin_hveh():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'tfin_policy_hh_veh')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def t_ini_hveh():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'tini_policy_hh_veh')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
