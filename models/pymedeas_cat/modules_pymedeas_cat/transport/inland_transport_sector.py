...
def activate_policy_inlandt():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'activate_inland_transp')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def adjust_energy_for_transport_to_inland_transport():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Austria', 'adjust_energy_for_transport_to_inland_transport')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def aux_hist_tveh():
    ...
    return xrmerge(
        rearrange(
            -float(hist_var_percent_tveh().loc["HV hib"])
        ...
        rearrange(
            float(hist_var_percent_tveh().loc["train liq"]),
            ["vehicleT"],
            {"vehicleT": ["train liq"]},
        ),
        rearrange(
            float(hist_var_percent_tveh().loc["train elec"]),
            ["vehicleT"],
            {"vehicleT": ["train elec"]},
        ),
    )
...
def energy_initial_inland_transport():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'energy_initial_inland_transport*')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: ['vehicleT']
...
def initial_percent_t_vehicles():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'initial_percent_T_vehicles*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['vehicleT']
...
def initial_vehicles_inland():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'initial_vehicles_inland*')
    Units: vehicle
    Limits: (None, None)
    Type: constant
    Subs: ['vehicleT']
...
def initial_xt_inland():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Austria', 'initial_Xt_inland')
    Units: T$
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_inlandt():
    ...
    return xrmerge(
        ...
        rearrange(p_percent_train_elec(), ["vehicleT"], {"vehicleT": ["train elec"]}),
...
def p_percent_bus_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_electr_bus_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_bus_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_natgas_bus_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_bus_hyb():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_hybrid_bus_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_hv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_gas_heavy_veh_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_hv_hyb():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_hybrid_heavy_veh_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_lv_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_electric_light_cargo_veh_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_lv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_natgas_light_cargo_veh_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_lv_hyb():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_hybrid_light_cargo_veh_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_percent_train_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'percent_electric_train_tfin')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def percent_tveh_1995():
    ...
    return xrmerge(
        ...
        rearrange(
            float(initial_percent_t_vehicles().loc["train liq"]),
            ["vehicleT"],
            {"vehicleT": ["train liq"]},
        ),
        rearrange(
            float(initial_percent_t_vehicles().loc["train elec"]),
            ["vehicleT"],
            {"vehicleT": ["train elec"]},
        ),
    )
...
def real_total_output_inland_transport():
    ...
    Original Eqn: SUM(Real total output by sector AUT[sectors!]*inland transport fraction[sectors!])/1e+06
    Units: T$
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    return (
        sum(
            real_total_output_by_sector_aut() * inland_transport_fraction(),
            dim=("sectors",),
        )
        / 1e06
    )
...
def t_fin_inlandt():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'tfin_policy_inland_transp_veh')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def t_ini_inlandt():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_aut.xlsx', 'BAU', 'tini_policy_inland_transp_veh')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
