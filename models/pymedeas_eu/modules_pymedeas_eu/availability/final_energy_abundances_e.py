...
def energy_scarcity_forgetting_time():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'energy_scarcity_forgetting_time')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def energy_scarcity_forgetting_time_h():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'energy_scarcity_forgetting_time_H')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def sensitivity_to_scarcity_option():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'sensitivity_to_scarcity_option')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def sensitivity_to_scarcity_option_h():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'sensitivity_to_scarcity_option_H')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
