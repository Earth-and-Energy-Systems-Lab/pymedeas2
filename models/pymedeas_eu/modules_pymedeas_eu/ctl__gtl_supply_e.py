...
def crash_programme_ctl():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'D110')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def crash_programme_gtl():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'D112')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def hist_growth_ctl():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'historic_growth_ctl')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def hist_growth_gtl():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'historic_growth_gtl')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_ctl_production(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_ctl_production')
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def historic_gtl_production(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_gtl_production')
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def initial_ctl_production():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'initial_ctl_production')
    Units: EJ/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def initial_gtl_production():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'initial_gtl_production')
    Units: EJ/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_ctl():
    """
    Real Name: P CTL
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'C110')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_gtl():
    """
    Real Name: P GTL
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'C112')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
_ext_constant_p_ctl = ExtConstant(
    "../../scenarios/scen_eu.xlsx", "BAU", "C110", {}, _root, "_ext_constant_p_ctl"
)


_ext_constant_p_gtl = ExtConstant(
    "../../scenarios/scen_eu.xlsx", "BAU", "C112", {}, _root, "_ext_constant_p_gtl"
)
