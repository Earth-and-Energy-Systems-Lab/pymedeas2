...
def historic_nonenergy_use(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_non_energy_use')
    Units: EJ
    Limits: (None, None)
    Type: lookup
    Subs: ['final sources']
...
def initial_nonenergy_use():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'initial_non_energy_use*')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: ['final sources']
