...
def historic_a_matrix():
    ...
    Original Eqn:
      GET DIRECT CONSTANTS('../economy.xlsx', 'Europe', 'historic_A_Matrix_year1995')
        .
        .
        .
      GET DIRECT CONSTANTS('../economy.xlsx', 'Europe', 'historic_A_Matrix_year2014')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
...
def ia_matrix_domestic():
    ...
    Original Eqn: IA Matrix[sec map 1,secb map 1]
    Units:
    Limits: (None, None)
    Type: component
    ...
    """
    return rearrange(
        rearrange(ia_matrix(), ["sec map 1", "secb map 1"], _subscript_dict),
        ["sectors", "sectors1"],
        _subscript_dict,
    )
...
def ia_matrix_exports():
    ...
    Original Eqn: IA Matrix[sec map 1,secb map 0]
    Units:
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'sectors1']
    ...
    """
    return rearrange(
        rearrange(ia_matrix(), ["sec map 1", "secb map 0"], _subscript_dict),
        ["sectors", "sectors1"],
        _subscript_dict,
    )
...
def ia_matrix_imports():
    ...
    Original Eqn: IA Matrix[sec map 0,secb map 1]
    Units:
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'sectors1']
    ...
    """
    return rearrange(
        rearrange(ia_matrix(), ["sec map 0", "secb map 1"], _subscript_dict),
        ["sectors", "sectors1"],
        _subscript_dict,
    )
...
def leontief_matrix_domestic():
    ...
    Original Eqn: Leontief Matrix[sec map 1,secb map 1]
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'sectors1']
    ...
    """
    return rearrange(
        rearrange(leontief_matrix(), ["sec map 1", "secb map 1"], _subscript_dict),
        ["sectors", "sectors1"],
        _subscript_dict,
    )
...
def leontief_matrix_exports():
    ...
    Original Eqn: Leontief Matrix[sec map 1,secb map 0]
    Units:
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'sectors1']
    ...
    """
    return rearrange(
        rearrange(leontief_matrix(), ["sec map 1", "secb map 0"], _subscript_dict),
        ["sectors", "sectors1"],
        _subscript_dict,
    )
...
def leontief_matrix_imports():
    ...
    Original Eqn: Leontief Matrix[sec map 0,secb map 1]
    Units:
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'sectors1']
    ...
    """
    return rearrange(
        rearrange(leontief_matrix(), ["sec map 0", "secb map 1"], _subscript_dict),
        ["sectors", "sectors1"],
        _subscript_dict,
    )
