...
def gdppc_until_p_customized_year_gdppc_evolution():
    ...
    Original Eqn: IF THEN ELSE(Time<P customized year GDPpc evolution, Desired GDPpc, Desired GDPpc)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def historic_capital_compensation(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../economy.xlsx', 'Europe', 'time_index2009', 'historic_capital_compensation')
    Units: Mdollars
    Limits: (None, None)
    Type: lookup
    Subs: ['sectors']
...
def historic_gdp(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../economy.xlsx', 'Europe', 'time_index2014', 'historic_GDP')
    Units: Mdollars
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def historic_labour_compensation(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../economy.xlsx', 'Europe', 'time_index2014', 'historic_labour_compensation')
    Units: Mdollars
    Limits: (None, None)
    Type: lookup
    Subs: ['sectors']
...
def input_gdppc_annual_growth():
    ...
    Original Eqn: GET DIRECT DATA('../economy.xlsx', 'Europe', 'time_index_projection', 'input_GDPpc_annual_growth')
    Units: Dmnl
    Limits: (None, None)
