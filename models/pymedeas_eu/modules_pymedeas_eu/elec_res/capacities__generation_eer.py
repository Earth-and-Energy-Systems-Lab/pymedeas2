...
def cpini_res_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'cp_initial_res_elec*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['RES elec']
...
def initial_instal_cap_res_elec():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'initial_installed_capacity_res_for_electricity*')
    Units: TW
    Limits: (None, None)
    Type: constant
    Subs: ['RES elec']
...
def min_cp_baseload_res():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'minimum_cp_baseload_res*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['RES elec']
...
def past_res_elec_capacity_growth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'historic_growth_res_for_electricity*')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: ['RES elec']
...
def table_hist_capacity_res_elec(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_installed_capacity_res_for_electricity'))
    Units: TW/Year
    Limits: (None, None)
    Type: lookup
    Subs: ['RES elec']
