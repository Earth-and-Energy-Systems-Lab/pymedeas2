...
def max_hydro_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'C24')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_oceanic_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'C27')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_offshore_wind_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'C29')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_onshore_wind_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'C28')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_pe_geotelec_twth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'C25')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_share_installed_pv_urban_vs_tot_pv():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'F35')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
