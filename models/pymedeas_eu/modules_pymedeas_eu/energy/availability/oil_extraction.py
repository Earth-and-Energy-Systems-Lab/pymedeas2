...
def cumulated_conv_oil_extraction_to_1995():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'cumulative_conventional_oil_extraction_until_1995')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def cumulated_unconv_oil_extraction_to_1995():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'cumulative_unconventional_oil_extraction_until_1995')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def extraction_conv_oil_ej():
    ...
    Original Eqn: IF THEN ELSE(RURR conv oil<0,0, IF THEN ELSE(Time<2016 :OR: "unlimited NRE?"=1 :OR: "unlimited oil?"=1, "PED domestic EU conv. oil EJ", MIN("PED domestic EU conv. oil EJ", max extraction conv oil EJ)))
    Units: EJ/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def extraction_tot_agg_oil_ej():
    ...
    Original Eqn: IF THEN ELSE(RURR tot agg oil<0,0, IF THEN ELSE(Time<2016 :OR: "unlimited NRE?"=1 :OR: "unlimited oil?"=1, PED domestic EU total oil EJ, MIN(PED domestic EU total oil EJ, max extraction tot agg oil EJ) ))
    Units: EJ/Year
    Limits: (None, None)
    Type: component
    Subs: None
...
def historic_unconv_oil():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_unconventional_oil_extraction')
    Units: EJ/Year
    Limits: (None, None)
...
def p_constraint_growth_extraction_unconv_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'p_constraint_growth_unconv_oil')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def separate_conv_and_unconv_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'separate_conv_and_unconv_oil')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_conv_oil_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'share_RURR_conv_oil_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_tot_agg_oil_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'share_RURR_agg_oil_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_unconv_oil_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'share_RURR_unconv_oil_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_unconv_oil_vs_tot_agg_in_2050():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'share_unconv_vs_agg_oil_in_2050')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_conv_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'start_policy_year_conv_oil_underground')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_tot_agg_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'start_policy_year_agg_oil_underground')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_unconv_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'start_policy_year_unconv_oil_underground')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def table_max_extraction_agg_oil(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'RURR_agg_oil', 'max_extraction_agg_oil'))
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def table_max_extraction_conv_oil(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'RURR_conv_oil', 'max_extraction_conv_oil'))
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def table_max_extraction_unconv_oil(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'RURR_unconv_oil', 'max_extraction_unconv_oil'))
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def unlimited_nre():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'unlimited_NRE')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def unlimited_oil():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'unlimited_oil')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_conv_oil_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'URR_conv_oil')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_tot_agg_oil_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'URR_agg_oil')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_unconv_oil_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'URR_unconv_oil')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
