...
def phaseout_oil_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'phase_out_oil_heat')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_in_target_year_oil_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'share_target_year_oil_for_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_policy_phaseout_oil_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'start_year_policy_phase_out_oil_for_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def target_year_policy_phaseout_oil_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'target_year_policy_phase_out_oil_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
