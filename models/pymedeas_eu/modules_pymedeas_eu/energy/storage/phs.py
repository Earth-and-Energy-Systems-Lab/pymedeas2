...
def cp_phs():
    """
    Real Name: Cp PHS
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'cp_phs')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def initial_instal_cap_phs():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'initial_installed_capacity_phs')
    Units: TW
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_potential_phs_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'max_PHS_potential')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_phs_growth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'p_PHS_growth')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def past_phs_capacity_growth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'historic_growth_phs_capacity')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def table_hist_capacity_phs(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_installed_capacity_phs'))
    Units: TW/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
