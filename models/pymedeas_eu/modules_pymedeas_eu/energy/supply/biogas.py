...
def efficiency_biogas_for_elec_chp_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'efficiency_biogas_for_elec_in_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_biogas_for_elec_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'efficiency_biogas_for_elec_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_biogas_for_heat_chp_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'efficiency_biogas_for_heat_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_biogas_for_heat_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'efficiency_biogas_for_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_biogas_pes(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'time_efficiencies', 'historic_primary_energy_supply_biogas')
    Units: EJ/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def past_biogas_growth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'average_historic_primary_energy_supply_biogas')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_biogas_for_chp():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'share_pes_biogas_for_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_biogas_for_elec_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'share_pes_biogas_for_elec_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_biogas_for_heatcom_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'share_pes_biogas_for_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_biogas_tfc():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'share_pes_biogas_tfc')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
