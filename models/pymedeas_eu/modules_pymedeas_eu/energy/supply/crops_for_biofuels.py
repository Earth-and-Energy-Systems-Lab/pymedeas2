...
def p_biofuels_marg_lands():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'p_biofuels_marg_land_growth')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def potential_marginal_lands_mha():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'pot_marg_land_biofuels')
    Units: MHa
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_production_biofuels(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'delta_years', 'start_production_biofuels')
    Units: ktoe/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def start_year_biofuels_land_marg():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'start_year_biofuels_land_marg')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
