...
def f1_solar_panels_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'efficiency_solar_panels_for_heat')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_res_capacity_for_heatcom(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_res_capacity_for_heat_commercial'))
    Units: TW
    Limits: (None, None)
    Type: lookup
    Subs: ['RES heat']
...
def initial_value_res_for_heatcom():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'initial_res_capacity_for_heat_commercial*')
    Units: TW
    Limits: (None, None)
    Type: constant
    Subs: ['RES heat']
...
def p_geothermal_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'p_geot_heat_growth')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_solar_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'p_solar_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_solid_bioe_for_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'p_solid_bioe_heat')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def past_res_growth_for_heatcom():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'historic_growth_res_for_heat_com*')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: ['RES heat']
...
def start_year_p_growth_res_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'start_year_p_growth_RES_heat')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def target_year_p_growth_res_heat():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'target_year_p_growth_RES_heat')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
