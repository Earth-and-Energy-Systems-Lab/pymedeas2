...
def historic_share_installed_pv_urban_vs_tot_pv():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_share_of_urban_pv_over_total')
    Units: Dmnl
    Limits: (None, None)
...
def max_hydro_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'max_hydro_potential')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_oceanic_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'max_oceanic_potential')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_offshore_wind_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'max_offshore_wind_potential')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_onshore_wind_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'max_onshore_wind_potential')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def max_pe_geotelec_twth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'max_PE_geot_elec_potential')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_share_installed_pv_urban_vs_tot_pv():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'share_PV_urban_tot_PV')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_solar_pv_vs_tot_solar_gen():
    ...
    Original Eqn: ZIDZ( FE Elec gen from solar PV on land TWh, real generation RES elec TWh[CSP]+FE Elec gen from solar PV on land TWh)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
