...
def max_fe_potential_res_for_heat():
    ...
    value.loc[["solid bioE heat"]] = max_pe_potential_solid_bioe_for_heat() * float(
...
def max_pe_potential_res_for_heat():
    ...
    value.loc[["solid bioE heat"]] = max_pe_potential_solid_bioe_for_heat()
    return value
...
def max_pe_res_for_heat():
    ...
    value.loc[["solid bioE heat"]] = available_max_pe_solid_bioe_for_heat()
    return value
