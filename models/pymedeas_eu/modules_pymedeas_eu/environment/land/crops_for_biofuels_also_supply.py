...
def additional_land_compet_available_for_biofuels():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'additional_land_compet_for_biofuels')
    Units: MHa
    Limits: (None, None)
    Type: constant
    Subs: None
...
def annual_shift_from_2gen_to_3gen():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'annual_shift_from_second_generation_to_third_generation')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_produc_biofuels_2gen(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'Europe', 'time_historic_data', 'historic_production_of_second_generation_biofuels'))
    Units: ktoe/Year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def initial_value_land_compet_biofuels_2gen_ktoe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'initial_production_of_second_generation_biofuels')
    Units: EJ/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_biofuels_2gen_land_compet():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'p_biofuels_2gen_land_compet')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_biofuels_3gen_land_compet():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'p_biofuels_3gen_land_compet')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def past_biofuels_2gen():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'historic_growth_biofuels_second_generation')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_3gen_cellulosic_biofuels():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'start_year_3gen_cell_biofuels')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
