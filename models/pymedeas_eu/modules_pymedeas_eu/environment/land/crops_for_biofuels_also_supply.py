...
@component.add(
    ...
    comp_subtype="Normal",
    depends_on={
        "initial_ktoe_compet_biofuels_2gen": 1,
        "ej_per_ktoe": 1,
        "land_productivity_biofuels_2gen_ej_mha": 1,
    },
)
def historic_land_compet_available_for_biofuels_2gen():
    ...
    """
    return (
        initial_ktoe_compet_biofuels_2gen()
        * ej_per_ktoe()
...
@component.add(
    name="initial_ktoe_compet_biofuels_2gen",
    units="ktoe/year",
    comp_type="Constant",
    comp_subtype="Normal",
)
def initial_ktoe_compet_biofuels_2gen():
    return 74847.7
...
def new_biofuels_2gen_land_compet():
    """
    New land dedicated to biofuels 2nd generation in land competing with other uses. IF THEN ELSE(check liquids<0, "constrain liquids exogenous growth?"*Land compet biofuels 2gen Mha/"1 year", MAX(Annual additional historic land use biofuels 2gen+adapt growth biofuels 2gen *Land compet biofuels 2gen Mha*Biofuels land compet available,0))
    """
    return np.maximum(
...
def past_biofuels_2gen():
    """
    Current anual growth patterns (1990-2015).
    """
