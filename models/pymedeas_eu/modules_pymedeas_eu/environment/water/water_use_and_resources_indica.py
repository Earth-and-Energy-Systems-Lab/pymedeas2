...
def ar_water():
    """
    Real Name: AR water
    Original Eqn: GET DIRECT CONSTANTS('../parameters.xlsx', 'Europe', 'accessible_runnoff_water')
    Units: km3
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_water_by_type_intensities_by_sector():
    ...
    Original Eqn: IF THEN ELSE( Time<2009, Historic water use[sectors,water](Time)/Real total output by sector EU[ sectors], 0)
    Units: dam3/Mdollars
    Limits: (None, None)
    Type: component
    Subs: ['sectors', 'water']
...
def historic_water_use(x):
    ...
    Original Eqn:
      GET DIRECT LOOKUPS('../water.xlsx', 'Europe', 'year', 'historic_water_use_blue_water')
      GET DIRECT LOOKUPS('../water.xlsx', 'Europe', 'year', 'historic_water_use_green_water')
      GET DIRECT LOOKUPS('../water.xlsx', 'Europe', 'year', 'historic_water_use_gray_water')
    Units: dam3/$
    Limits: (None, None)
    Type: lookup
...
def renewable_water_resources():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../parameters.xlsx', 'Europe', 'renewable_water_resources')
    Units: km3
    Limits: (None, None)
    Type: constant
    Subs: None
