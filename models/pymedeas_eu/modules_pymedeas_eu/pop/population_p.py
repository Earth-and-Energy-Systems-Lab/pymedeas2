...
def historic_population(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../parameters.xlsx', 'Europe', 'time_historic_population', 'historic_population')
    Units: people
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def initial_population():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../parameters.xlsx', 'Europe', 'initial_population')
    Units: people
    Limits: (None, None)
    Type: constant
    Subs: None
...
def input_population(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../parameters.xlsx', 'Europe', 'time_index_projection', 'input_population'))
    Units: Mpeople
    Limits: (None, None)
    Type: lookup
    Subs: None
