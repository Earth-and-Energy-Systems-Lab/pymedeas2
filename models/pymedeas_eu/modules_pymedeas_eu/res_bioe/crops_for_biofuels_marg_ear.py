...
def p_biofuels_marg_lands():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'F46')
    Units: 1/Year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def potential_marginal_lands_mha():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'C43')
    Units: MHa
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_biofuels_land_marg():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_eu.xlsx', 'BAU', 'F45')
    Units: Year
    Limits: (None, None)
    Type: constant
    Subs: None
