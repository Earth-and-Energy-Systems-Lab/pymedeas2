...
def adjust_energy_for_transport_to_inland_transport():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'Europe', 'adjust_energy_for_transport_to_inland_transport')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def energy_initial_inland_transport():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Europe', 'energy_initial_inland_transport*')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: ['vehicleT']
...
def initial_percent_t_vehicles():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Europe', 'initial_percent_T_vehicles*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: ['vehicleT']
...
def initial_vehicles_inland():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Europe', 'initial_vehicles_inland*')
    Units: vehicle
    Limits: (None, None)
    Type: constant
    Subs: ['vehicleT']
...
def initial_xt_inland():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../transport.xlsx', 'Europe', 'initial_Xt_inland')
    Units: T$
    Limits: (None, None)
    Type: constant
    Subs: None
...
def real_total_output_inland_transport():
    ...
    Original Eqn: SUM(Real total output by sector EU[sectors!]*inland transport fraction[sectors!])/1e+06
    Units: T$
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    return (
        sum(
            real_total_output_by_sector_eu() * inland_transport_fraction(),
            dim=("sectors",),
        )
        / 1e06
    )
