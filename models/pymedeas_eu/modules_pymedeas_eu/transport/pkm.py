...
@component.add(
    name="real variation pkm",
    units="pkm",
    subscripts=["fuels", "Transport Modes pkm"],
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"real_pkm_by_mode_and_fuel": 1, "real_pkm_by_mode_and_fuel_delayed": 1},
)
def real_variation_pkm():
    return real_pkm_by_mode_and_fuel() - real_pkm_by_mode_and_fuel_delayed()
