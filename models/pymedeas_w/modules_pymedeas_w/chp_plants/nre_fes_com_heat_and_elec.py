...
def efficiency_elec_coal_chp_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_electricity_coal_chp_plants')
    Units: Dmnl
    Limits: (None, None)
...
def efficiency_elec_gas_chp_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_electricity_gas_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def efficiency_elec_oil_chp_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_electricity_liquids_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def efficiency_heat_coal_chp_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_heat_coal_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def efficiency_heat_gas_chp_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_heat_gas_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def efficiency_heat_oil_chp_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_heat_liquids_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def historic_share_chp_plants_gas():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_historic_data', 'historic_share_chp_plants_gas')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def historic_share_chp_plants_oil():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_historic_data', 'historic_share_chp_plants_oil')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def share_heatcom_chp_plants_nre_vs_nre_tot_heatcom_generation():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_historic_data', 'historic_share_commercial_heat_in_chp_on_total_commercial_heat_generation')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def share_of_heat_production_in_chp_plants_vs_total_nucelar_elec_generation():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_heat_output_vs_electricity_in_nuclear')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
