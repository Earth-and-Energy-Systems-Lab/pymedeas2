...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"p_timeseries_gdppc_growth_rate": 1, "gdppc_sensitivity_factor": 1},
)
def annual_gdppc_growth_rate():
    return p_timeseries_gdppc_growth_rate() + gdppc_sensitivity_factor()
...
@component.add(
    name="gdppc_sensitivity_factor",
    units="Dmnl",
    comp_type="Constant",
    comp_subtype="Normal",
)
def gdppc_sensitivity_factor():
    return 0
