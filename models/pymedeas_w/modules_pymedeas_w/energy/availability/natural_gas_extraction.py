...
def p_constraint_growth_extraction_unconv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'C96')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def separate_conv_and_unconv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'C83')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_conv_gas_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'C127')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_tot_agg_gas_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'F128')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_unconv_gas_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'C129')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_conv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'C126')
    Units: year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_tot_agg_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'F126')
    Units: year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_unconv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'C128')
    Units: year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def unlimited_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'E83')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
