...
def abundance_total_nat_gas():
    ...
    Original Eqn: IF THEN ELSE("PED nat. gas EJ"<PES nat gas, 1, 1-ZIDZ(("PED nat. gas EJ"-PES nat gas), "PED nat. gas EJ"))
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def cumulated_conv_gas_extraction_to_1995():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'cumulative_conventional_gas_extraction_until_1995')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def cumulated_unconv_gas_extraction_to_1995():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'cumulative_unconventional_gas_extraction_until_1995')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def evolution_share_unconv_gas_vs_tot_agg():
    ...
    Original Eqn: (share unconv gas vs tot agg in 2050-0.1268)/(2050-2012)*Time+(share unconv gas vs tot agg in 2050-((share unconv gas vs tot agg in 2050-0.1268)/(2050-2012))*2050)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def extraction_conv_gas_ej():
    ...
    Original Eqn: IF THEN ELSE(RURR conv gas<0,0, IF THEN ELSE("unlimited NRE?"=1 :OR: "unlimited gas?"=1, Demand conv gas, MIN(Demand conv gas, max extraction conv gas EJ)))
    Units: EJ/year
    Limits: (None, None)
    Type: component
    Subs: None
...
def extraction_tot_agg_gas_ej():
    ...
    Original Eqn: IF THEN ELSE(RURR tot agg gas<0,0, IF THEN ELSE("unlimited NRE?"=1 :OR: "unlimited gas?"=1, "PED nat. gas EJ", MIN("PED nat. gas EJ", max extraction tot agg gas EJ)))
    Units: EJ/year
    Limits: (None, None)
    Type: component
    Subs: None
...
def historic_unconv_gas():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_historic_data', 'historic_unconventional_gas_extraction')
    Units: EJ/year
    Limits: (None, None)
...
def increase_scarcity_conv_gas():
    ...
    Original Eqn: scarcity conv gas stock*ZIDZ( (scarcity conv gas-scarcity conv gas delayed 1yr), scarcity conv gas)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def p_constraint_growth_extraction_unconv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'unconv_gas_growth')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def pes_nat_gas_without_gtl():
    ...
    Original Eqn: PES nat gas-"PED nat. gas for GTL EJ"
    Units: EJ/year
    Limits: (None, None)
    Type: component
    Subs: None
...
def real_extraction_conv_gas_emissions_relevant_ej():
    ...
    Original Eqn: MAX(0, real extraction conv gas EJ-("PED nat. gas for GTL EJ"+"Non-energy use demand by final fuel EJ"[gases])*share conv vs total gas extraction)
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def real_extraction_unconv_gas_emissions_relevant_ej():
    ...
    Original Eqn: MAX(0, real extraction unconv gas EJ-("PED nat. gas for GTL EJ" +"Non-energy use demand by final fuel EJ"[gases])*(1-share conv vs total gas extraction))
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def scarcity_conv_gas():
    ...
    Priority to conventional resource to cover the demand while the maximum
        extraction level of energy/time is not reached.
    """
    return if_then_else(
...
def scarcity_conv_gas_delayed_1yr():
    ...
    Original Eqn: DELAY FIXED ( scarcity conv gas, 1, 0.2502)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def scarcity_conv_gas_stock():
    ...
    Original Eqn: INTEG ( increase scarcity conv gas, 0.2502)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def separate_conv_and_unconv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'separate_conv_unconv_gas')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_conv_gas_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'share_RURR_conv_gas_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_tot_agg_gas_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'share_RURR_agg_gas_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_rurr_unconv_gas_to_leave_underground():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'share_RURR_unconv_gas_underground')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_unconv_gas_vs_tot_agg_in_2050():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_unconv_vs_agg_gas_in_2050')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_conv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'start_policy_year_conv_gas_underground')
    Units: year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_tot_agg_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'start_policy_year_agg_gas_underground')
    Units: year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_policy_leave_in_ground_unconv_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'start_policy_year_unconv_gas_underground')
    Units: year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def table_max_extraction_agg_gas(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'World', 'RURR_agg_gas', 'max_extraction_agg_gas'))
    Units: EJ/year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def table_max_extraction_conv_gas(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'World', 'RURR_conv_gas', 'max_extraction_conv_gas'))
    Units: EJ/year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def table_max_extraction_unconv_gas(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'World', 'RURR_unconv_gas', 'max_extraction_unconv_gas'))
    Units: EJ/year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def unlimited_gas():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'unlimited_gas')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_conv_gas_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'URR_conv_gas')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_total_gas_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'URR_agg_gas')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def urr_unconv_gas_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'URR_unconv_gas')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def year_scarcity_total_nat_gas():
    ...
    Original Eqn: IF THEN ELSE(abundance total nat gas>0.95, 0, Time)
    Units:
    Limits: (None, None)
    Type: component
    Subs: None
