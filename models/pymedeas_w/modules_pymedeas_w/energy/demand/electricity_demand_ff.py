...
def abundance_primary_sources():
    ...
    """
    return xrmerge(
        rearrange(abundance_coal(), ["primary sources"], {"primary sources": ["coal"]}),
        rearrange(
            abundance_total_oil(), ["primary sources"], {"primary sources": ["oil"]}
        ),
        rearrange(
...
def efficiency_coal_for_electricity():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'efficiency_coal_for_electricity')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_liquids_for_electricity():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'efficiency_liquids_for_electricity')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def hist_share_gascoal_gas_elec():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_historic_data', 'historic_share_of_electricity_produced_from_gas_over_electricity_produced_coal_and_gas')
    Units: Dmnl
    Limits: (None, None)
...
def hist_share_oilff_elec():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_historic_data', 'historic_share_of_electricity_produced_from_oil_over_total_fossil_electricity')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None

    Share of oil for electricity (Data extracted from database World Bank:
        "Electricity production from oil sources (% of total) " / "Electricity
        production from oil, gas and coal sources (% of total)").
    """
...
def historic_efficiency_gas_for_electricity(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_gas_for_electricity'))
    Units: percent
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def improvement_efficiency_gas_for_electricity():
    ...
    Original Eqn: IF THEN ELSE(Time<2013, (Historic efficiency gas for electricity(Time+1)-Historic efficiency gas for electricity(Time))*percent to share, efficiency gas for electricity*remaining efficiency improv gas for electricity*Efficiency improv gas for electricity)
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def initial_efficiency_gas_for_electricity():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'initial_efficiency_gas_for_electricity')
    Units: percent
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_gascoalgas_for_elec_in_2014():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_of_electricity_produced_from_gas_over_electricity_produced_coal_and_gas_2014')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_oilff_for_elec_in_2015():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_of_electricity_produced_from_oil_over_total_fossil_electricity_2015')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
