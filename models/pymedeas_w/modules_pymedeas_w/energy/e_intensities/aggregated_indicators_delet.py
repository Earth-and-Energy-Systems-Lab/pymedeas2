"""
Module aggregated_indicators_delet
...
def annual_tfes_intensity_growth_rate():
    """
    Real Name: Annual TFES intensity growth rate
...
def annual_tfes_intensity_growth_rate_without_eroi():
    """
    Real Name: Annual TFES intensity growth rate without EROI
...
def annual_tpes_intensity_growth_rate():
    """
    Real Name: Annual TPES intensity growth rate
...
def tfes_intensity_ej_t():
    ...
    Original Eqn: ZIDZ( Real TFEC, GDP )
    Units: EJ/T$
    Limits: (None, None)
    Type: component
    Subs: None
