...
def esoi_ev_batteries():
    ...
    Original Eqn: lifetime EV batteries*Cp EV batteries for elec storage*MW in 1 year to MJ/(quality of electricity*"Energy intensity construction EV batteries MJ/MW"*(1+Share energy requirements for decom EV batteries+Grid correction factor EV batteries))
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
