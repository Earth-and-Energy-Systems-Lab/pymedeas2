...
def max_potential_phs_twe():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'max_potential_PHS_potential')
    Units: TWe
    Limits: (None, None)
    Type: constant
    Subs: None
...
def p_phs_growth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'p_phs_growth')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
