...
def modern_bioe_in_households():
    ...
    Original Eqn: Households final energy demand[solids]-PE traditional biomass consum EJ
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def pe_consumption_trad_biomass_ref():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'pe_consumption_trad_biomass_ref')
    Units: EJ/year
    Limits: (None, None)
    Type: constant
    Subs: None
...
def pe_traditional_biomass_ej_delayed_1yr():
    ...
    Original Eqn: DELAY FIXED ( PE traditional biomass consum EJ, 1, 30)
    Units: EJ/year
    Limits: (None, None)
    Type: component
    Subs: None
...
def people_relying_trad_biomass_ref():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../parameters.xlsx', 'World', 'people_relying_on_traditional_biomass')
    Units: people
    Limits: (None, None)
    Type: constant
    Subs: None
...
def pepc_consumption_people_depending_on_trad_biomass():
    ...
    Original Eqn: PE consumption trad biomass ref/People relying trad biomass ref
    Units: MToe/people
    Limits: (None, None)
    Type: component
    Subs: None
...
def population_dependent_on_trad_biomass():
    ...
    Original Eqn: PE traditional biomass consum EJ/PEpc consumption people depending on trad biomass
    Units: people
    Limits: (None, None)
    Type: component
    Subs: None
...
def share_trad_biomass_vs_solids_in_households():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_trad_biomass_vs_solids_in_households')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
