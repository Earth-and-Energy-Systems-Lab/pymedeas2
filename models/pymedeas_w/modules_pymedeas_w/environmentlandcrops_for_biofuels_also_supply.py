"""
Module environmentlandcrops_for_biofuels_also_supply
...
@component.add(
    name="Biofuels production in 2015",
    units="ktoe/year",
    comp_type="Constant",
    comp_subtype="Normal",
)
...
@component.add(
    name='"Max PEavail potential biofuels 2-3gen"',
    units="EJ/year",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
