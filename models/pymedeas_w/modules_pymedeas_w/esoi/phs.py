...
def esoi_phs():
    """
    Real Name: ESOI PHS
    Original Eqn: ZIDZ( output PHS over lifetime, CEDtot over lifetime PHS*quality of electricity )
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def final_energy_invested_phs():
    ...
    Original Eqn: potential FE elec stored PHS TWh*EJ per TWh/ESOI PHS
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
