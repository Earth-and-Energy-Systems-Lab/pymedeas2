...
def choose_energy_intensity_target_method():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'choose_energy_intensity_target_method')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_rate_of_substitution():
    ...
    Original Eqn:
      GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'efficiency_rate_of_substitution_electricity*')
      GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'efficiency_rate_of_substitution_heat*')
      GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'efficiency_rate_of_substitution_liquids*')
      GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'efficiency_rate_of_substitution_gases*')
      GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'efficiency_rate_of_substitution_solids*')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
...
def pct_change_energy_intensity_target():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'pct_change_energy_intensity_target')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def start_year_modification_ei():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'start_year_modification_EI')
    Units: year
    Limits: (None, None)
    Type: constant
    Subs: None

    Year in which the energy intensity modification starts in energy intensity
        target method 1
    """
...
def year_change_pct_energy_intensity_target():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../../scenarios/scen_w.xlsx', 'BAU', 'year_change_pct_energy_intensity_target')
    Units: year
    Limits: (None, None)
    Type: constant
    Subs: None
