...
def efficiency_coal_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_coal_heat_plants')
    Units: Dmnl
    Limits: (None, None)
...
def efficiency_gases_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_gases_for_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def efficiency_liquids_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_efficiencies', 'historic_efficiency_liquids_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def fed_heat_liquids_plants_ej():
    ...
    Original Eqn: "FED Heat-com plants fossil fuels EJ"*share liquids fot heat plants
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def historic_share_gascoalgas_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_historic_data', 'historic_share_of_heat_produced_from_gas_over_electricity_produced_coal_and_gas')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def historic_share_liquids_for_heat_plants():
    ...
    Original Eqn: GET DIRECT DATA('../energy.xlsx', 'World', 'time_historic_data', 'historic_share_of_liquids_in_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: component_ext_data
    Subs: None
...
def share_gascoalgas_for_heat_plants():
    ...
    Original Eqn: "Historic share gas/(coal+gas) for heat plants"
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
