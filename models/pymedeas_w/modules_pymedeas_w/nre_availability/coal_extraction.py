...
def abundance_coal():
    ...
    Original Eqn: IF THEN ELSE(extraction coal EJ>PED coal EJ, 1, 1-ZIDZ( (PED coal EJ-extraction coal EJ), PED coal EJ))
    Units: Dmnl
    Limits: (None, None)
    Type: component
    Subs: None
...
def cumulated_coal_extraction():
    ...
    Original Eqn: INTEG ( extraction coal EJ, cumulated coal extraction to 1995)
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def cumulated_coal_extraction_to_1995():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'cumulative_coal_extraction_until_1995')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def extraction_coal_ej():
    ...
    Original Eqn: IF THEN ELSE(RURR coal<0,0, IF THEN ELSE("unlimited NRE?"=1 :OR: "unlimited coal?"=1, PED coal EJ,MIN(PED coal EJ , max extraction coal EJ)))
    Units: EJ/year
    Limits: (None, None)
    Type: component
    Subs: None
...
def extraction_coal_mtoe():
    ...
    Original Eqn: extraction coal EJ*MToe per EJ
    Units: MToe/year
    Limits: (None, None)
    Type: component
    Subs: None
...
def extraction_coal_without_ctl_ej():
    ...
    Original Eqn: MAX(extraction coal EJ-extraction coal for CTL EJ, 0)
    Units: EJ/year
    Limits: (None, None)
    Type: component
    Subs: None
...
def rurr_coal():
    """
    Real Name: RURR coal
    Original Eqn: INTEG ( -extraction coal EJ-Flow coal left in ground, URR coal-cumulated coal extraction to 1995)
    Units: EJ
    Limits: (None, None)
    Type: component
    Subs: None
...
def table_max_extraction_coal(x):
    ...
    Original Eqn: ( GET DIRECT LOOKUPS('../energy.xlsx', 'World', 'RURR_coal', 'max_extraction_coal'))
    Units: EJ/year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def urr_coal_input():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'URR_coal')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def year_scarcity_coal():
    ...
    Original Eqn: IF THEN ELSE(abundance coal>0.95, 0, Time)
    Units: year
    Limits: (None, None)
    Type: component
    Subs: None
