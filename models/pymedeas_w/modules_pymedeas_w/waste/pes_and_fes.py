...
def efficiency_waste_for_elec_chp_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'efficiency_waste_for_elec_chp_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_waste_for_elec_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'efficiency_waste_for_elec_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_waste_for_heat_chp_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'efficiency_waste_for_heat_CHP_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def efficiency_waste_for_heat_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'efficiency_waste_for_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def historic_pes_waste_ej(x):
    ...
    Original Eqn: GET DIRECT LOOKUPS('../energy.xlsx', 'World', 'time_historic_data', 'historic_primary_energy_supply_of_waste')
    Units: EJ/year
    Limits: (None, None)
    Type: lookup
    Subs: None
...
def initial_pes_waste():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'initial_primary_energy_supply_from_waste')
    Units: EJ
    Limits: (None, None)
    Type: constant
    Subs: None
...
def new_waste_supply_ej():
    ...
    Original Eqn: IF THEN ELSE(Time<2014, (Historic PES waste EJ(Time+1)-Historic PES waste EJ(Time)), IF THEN ELSE(max waste=0,PES waste EJ*P waste change , ((max waste-PES waste EJ)/max waste)*adapt growth waste*PES waste EJ))
    Units: EJ/year
    Limits: (None, None)
    Type: component
    Subs: None
    ...
    return if_then_else(
        ...
        lambda: if_then_else(
            ...
            lambda: ((max_waste() - pes_waste_ej()) / max_waste())
            * adapt_growth_waste()
            * pes_waste_ej(),
        ),
    )
...
def past_waste_growth():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'historic_average_pes_from_waste_growth')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_waste_for_chp():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_pes_waste_for_chp')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_waste_for_elec_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_pes_waste_for_elec_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_waste_for_heatcom_plants():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_pes_waste_for_heat_plants')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def share_pes_waste_tfc():
    ...
    Original Eqn: GET DIRECT CONSTANTS('../energy.xlsx', 'World', 'share_pes_waste_tfc')
    Units: Dmnl
    Limits: (None, None)
    Type: constant
    Subs: None
...
def waste_change():
    ...
    Original Eqn: IF THEN ELSE(Annual GDP growth rate<0, Annual GDP growth rate, P waste change)
    Units: 1/year
    Limits: (None, None)
    Type: component
    Subs: None
