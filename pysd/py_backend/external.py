...
class External(object):
    ...
    def _initialize_data(self, element_type):
        ...
        if np.any(np.isnan(data)):
            ...
            # fill values
            self._fill_missing(series, data, series_across)
    ...
    def _fill_missing(self, series, data, series_across):
        """
        ...
        series_across: str
          infromation of the series read method for possible error message.
        ...
        try:
            ...
            raise ValueError(
              ...
              + "Data given in:\n"
              + self._file_sheet
              + "\t{}:\t{}\n".format(series_across, self.cell)
              + " has length 0"
              )
